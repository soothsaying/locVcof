...
lambdav<-seq(0.01*(n/5)^{-1/5},1.5*(n/5)^{-1/5},length=50) #LASSO


###TLP
if(flag==4){
tauv<-seq(0.001*(n/5)^{-1/5},1.5*(n/5)^{-1/5},length=200)
